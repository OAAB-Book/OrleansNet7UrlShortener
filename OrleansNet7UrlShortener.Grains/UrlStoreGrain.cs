...
namespace OrleansNet7UrlShortener.Grains
{
    ...
    public class UrlStoreGrain : IGrainBase, IUrlStoreGrain
    {
        ...
        private readonly IStorage<KeyValuePair<string, string>> _cache;

        public UrlStoreGrain(IGrainContext grainContext,
            [PersistentState(stateName: "actual-url", storageName: "url-store")] IStorage<KeyValuePair<string, string>> cache)
        {
